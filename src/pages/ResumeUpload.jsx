...
//   const formData = new FormData();
//   formData.append("cv", file); // 🔥 MUST be "cv"
...
//         input { display: none; }
//         @media (max-width: 600px) { .modal { padding: 20px 16px; } .upload-box { padding: 30px 10px; } }
//       `}</style>
...
//             <span>
//               Your CV will be automatically sent to the HR team once you submit.
//             </span>
//           </div>
